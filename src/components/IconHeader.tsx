...
const IconHeader = ({kind, href, tooltip}: ISocialIcon) => {
  ...
  return (
    <div className={"group tooltip tooltip-bottom"} data-tip={tooltip}>
      ...
      <button className=" hover:fill-current btn btn-circle btn-outline text-orange-700 border border-orange-700 hover:border-orange-700 hover:bg-zinc-100 hover:text-white focus:ring-2
              focus:outline-none focus:ring-orange-500 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center
              dark:hover:bg-zinc-700 dark:border-orange-500 dark:text-orange-500 dark:hover:text-white dark:focus:ring-orange-400">
        <SocialSvg
