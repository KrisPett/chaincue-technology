...
const AboutButton = ({title, onClick}: IButton) => {
  return (
    <button
      draggable
      onClick={onClick}
      onDragEnd={onClick}
      className="btn relative inline-flex items-center justify-center xxs:w-full md:w-fit p-0.5 mb-2 mr-2 overflow-hidden text-sm font-medium
